...
const content = {
  fr: {
    ...
    defP1: "Digitaliser ne veut pas dire « avoir un site web » ou « utiliser Excel ». C'est remplacer les processus lents, manuels et coûteux par des systèmes intelligents qui travaillent automatiquement, vous donnent des données fiables et libèrent votre équipe.",
  ...
  en: {
    ...
    defP1: "Digitalising doesn't mean 'having a website' or 'using Excel'. It means replacing slow, manual and costly processes with intelligent systems that work automatically, give you reliable data and free up your team.",
    ...
    pillars: [
      ...
      { title: "Artificial intelligence",  desc: "Delegate repetitive tasks to AI agents. Your teams focus on what creates real value." },
    ...
    faqs: [
      ...
      { q: "Will AI replace my employees?",                             a: "No. AI handles repetitive tasks — data entry, scheduling, reports. Your teams do higher-value work and are more satisfied." },
