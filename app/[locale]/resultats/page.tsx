...
const content = {
  fr: {
    ...
    roiMetrics: [
      ...
      { value: "15h",    label: "récupérées par collaborateur par semaine", sub: "Automatisation des tâches à faible valeur ajoutée" },
    ...
    problemScenarios: [
      ...
      { domain: "Solutions IA", color: "#7c3aed", problem: "Équipe support débordée, temps de réponse moyen de 6 heures, demandes récurrentes qui mobilisent les collaborateurs.", solution: "Assistance IA disponible en continu sur vos canaux existants, triage automatique, escalade vers vos équipes pour les cas complexes.", results: ["-70% tickets traités manuellement", "Réponse < 30 sec", "Équipes mobilisées sur les cas complexes"] },
  ...
  en: {
    ...
    roiMetrics: [
      ...
      { value: "15h",    label: "recovered per team member per week",  sub: "Automation of low-value tasks" },
    ...
    problemScenarios: [
      ...
      { domain: "AI Solutions", color: "#7c3aed", problem: "Overloaded support team, average response time of 6 hours, recurring requests occupying staff.", solution: "AI assistance available around the clock on existing channels, automatic triage, escalation to your teams for complex cases.", results: ["-70% tickets handled manually", "Response < 30 sec", "Teams focused on complex cases"] },
