...
const caseStudies = [
  {
    ...
    results: [
      ...
      { metric: "3h → 5 min", label: "pour les rapports hebdo" },
    ],
    timeline: "3 mois",
  },
  {
    ...
    <div className="bg-white text-slate-900">
      ...
      <section className="relative overflow-hidden bg-gradient-to-br from-white via-slate-50 to-blue-50/40 pb-20 pt-36">
        ...
        <div className="relative mx-auto max-w-[1400px] px-6 text-center lg:px-10">
          ...
          <p className="mx-auto mb-6 max-w-2xl text-xl leading-relaxed text-slate-500">
      ...
      <section className="py-20 bg-white border-y border-slate-100">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div className="grid grid-cols-2 gap-5 md:grid-cols-3 lg:grid-cols-6">
            {roiMetrics.map((m) => (
              <div key={m.value} className="rounded-2xl border border-slate-100 p-5 text-center hover:-translate-y-1 hover:border-blue-100 hover:shadow-[0_8px_24px_rgba(37,99,235,.08)] transition-all duration-300">
                <div className="mb-1 text-3xl font-black bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">
                  {m.value}
                </div>
                <div className="mb-1 text-[13px] font-black text-slate-700">{m.label}</div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          <div className="mb-14 text-center">
            ...
            <h2 className="text-4xl font-black tracking-tight text-slate-900 lg:text-5xl">
              Comment on l'a fait,{" "}
              <span className="bg-gradient-to-r from-blue-600 to-cyan-500 bg-clip-text text-transparent">étape par étape</span>
            </h2>
          </div>

          <div className="grid gap-6 lg:grid-cols-3">
            {caseStudies.map((cs) => (
              <div key={cs.company} className="flex flex-col rounded-2xl border border-slate-200 bg-white shadow-sm hover:shadow-md hover:-translate-y-1 transition-all duration-300 overflow-hidden">
                <div className="border-b border-slate-100 bg-gradient-to-r from-blue-50 to-cyan-50 px-6 py-4">
                  <div className="text-[11px] font-black uppercase tracking-widest text-blue-600 mb-1">{cs.sector}</div>
                  <div className="font-black text-slate-800">{cs.company}</div>
                  <div className="text-[12px] text-slate-400 mt-1">Résultats en {cs.timeline}</div>
                </div>
                <div className="flex-1 p-6 space-y-5">
                  <div>
                    <div className="text-[11px] font-black uppercase tracking-widest text-red-400 mb-2">Problème</div>
                    <p className="text-sm leading-relaxed text-slate-600">{cs.challenge}</p>
                  </div>
                  <div>
                    <div className="text-[11px] font-black uppercase tracking-widest text-blue-500 mb-2">Solution Kadrek</div>
                    <p className="text-sm leading-relaxed text-slate-600">{cs.solution}</p>
                  </div>
                  <div>
                    <div className="text-[11px] font-black uppercase tracking-widest text-emerald-500 mb-3">Résultats</div>
                    <div className="grid grid-cols-3 gap-2">
                      {cs.results.map((r) => (
                        <div key={r.label} className="rounded-xl bg-emerald-50 border border-emerald-100 p-2.5 text-center">
      ...
      <section className="py-24 bg-white">
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="grid gap-5 md:grid-cols-2 lg:grid-cols-3">
            {testimonials.map((t) => (
              <div key={t.name} className="flex flex-col rounded-2xl border border-slate-100 p-6 hover:border-blue-100 hover:-translate-y-1 hover:shadow-[0_8px_30px_rgba(37,99,235,.08)] transition-all duration-300">
                <div className="mb-3 inline-flex self-start items-center gap-1.5 rounded-full bg-emerald-50 border border-emerald-100 px-3 py-1 text-[11px] font-black text-emerald-700">
                  ✓ {t.result}
                </div>
                <div className="mb-3 text-yellow-400 tracking-wider">{"★".repeat(t.stars)}</div>
                <p className="flex-1 text-[14px] leading-relaxed text-slate-600 italic mb-5">"{t.text}"</p>
                <div className="flex items-center gap-3 border-t border-slate-100 pt-4">
                  <div className="flex h-9 w-9 flex-shrink-0 items-center justify-center rounded-full bg-gradient-to-br from-blue-600 to-cyan-500 text-xs font-black text-white">
                    {t.initials}
                  </div>
                  <div>
        ...
        <div className="mx-auto max-w-[1400px] px-6 lg:px-10">
          ...
          <div className="grid md:grid-cols-2 gap-6 max-w-4xl mx-auto">
            <div className="rounded-2xl border-2 border-red-100 bg-red-50 p-8">
              <p className="mb-5 text-[11px] font-black uppercase tracking-widest text-red-500">💸 Sans digitalisation — coûts réels</p>
              <ul className="space-y-3">
                {[
                  ...
                  <li key={l} className="flex items-center gap-3 text-sm text-slate-700">
            ...
            <div className="rounded-2xl border-2 border-emerald-100 bg-emerald-50 p-8">
              <p className="mb-5 text-[11px] font-black uppercase tracking-widest text-emerald-600">💎 Avec Kadrek — après 6 mois</p>
              <ul className="space-y-3">
                {[
      ...
      <section className="bg-gradient-to-br from-slate-900 via-blue-950 to-slate-900 py-24">
        <div className="mx-auto max-w-[1400px] px-6 text-center lg:px-10">
          <h2 className="mb-5 text-4xl font-black text-white lg:text-5xl">Ces résultats peuvent être les vôtres</h2>
          <p className="mb-10 text-xl text-white/60 max-w-xl mx-auto">
            Commencez par un audit gratuit. On identifie vos opportunités et on vous donne un plan concret — en 45 minutes.
          </p>
          <Link href="/contact"
