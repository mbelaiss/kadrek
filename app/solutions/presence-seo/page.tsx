...
export const metadata: Metadata = {
  title: "Présence Digitale & SEO | Kadrek",
  description: "Site web haute performance, SEO, réputation en ligne. Soyez trouvé avant vos concurrents sur Google.",
};

export default function PresenceSeoPage() {
  return (
    <SolutionPage
      ...
      useCases={[
        {
          icon: "🏗️",
          scenario: "BTP — Acquisition locale par SEO",
          challenge: "Entreprise de rénovation invisible sur Google. 100% du business via bouche-à-oreille. Croissance plafonnée.",
          solution: "Refonte SEO technique, création de pages locales par ville, Google Business optimisé, avis clients sollicités.",
          result: "Page 1 Google sur 12 mots-clés locaux en 4 mois. +35 leads qualifiés / mois. CA +28%.",
        },
        {
          icon: "🛍️",
          scenario: "E-commerce — Performance et conversion",
          challenge: "Boutique en ligne avec 3 000 visiteurs/mois mais seulement 0,8% de conversion. Site lent (6s de chargement).",
          solution: "Optimisation Core Web Vitals, refonte du parcours d'achat, A/B tests, retargeting configuré.",
          result: "Chargement 6s → 1,2s. Conversion 0,8% → 2,4%. CA e-commerce ×3 sans augmenter le trafic.",
        },
        {
          icon: "💼",
          scenario: "Cabinet conseil — Personal branding et SEO",
          challenge: "Consultant expert dans son domaine mais aucune présence en ligne. Prospects ne trouvent pas de preuves sociales.",
          solution: "Site vitrine expert, articles de blog SEO mensuels, profil LinkedIn optimisé, témoignages clients intégrés.",
          result: "15 articles positionnés page 1. 8 nouveaux clients inbound en 6 mois. Taux de closing amélioré.",
        },
        {
          icon: "🏨",
          scenario: "Hôtellerie — Réputation et réservations directes",
          challenge: "Hôtel avec 65% de réservations via OTA (commission 18%). Avis mixtes non gérés sur TripAdvisor et Google.",
          solution: "Stratégie de gestion des avis, site optimisé pour réservations directes, SEO local, contenu social régulier.",
          result: "Avis moyen 3,8 → 4,6. Réservations directes +45%. Commission OTA économisée : 22k€/an.",
        },
      ]}
      features={[
